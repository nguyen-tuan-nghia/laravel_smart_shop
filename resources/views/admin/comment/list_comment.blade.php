      ...
      <table class="table table-striped b-t b-light" id="myTable">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{ $comm->customer->customer_name }}</td>
            ...
            <td>{{ $comm->comment }}
              ...
              <ul class="list_rep">
                ...
                @foreach($comment_rep as $key => $comm_reply)
                  ...
                  <p>Người trả lời là: {{$comm_reply->person_replied_name}}</p>
...
{{--               <a href="" class="active styling-edit" ui-toggle-class="">
              ...
              <a onclick="return confirm('Bạn có chắc là muốn xóa bình luận này ko?')" href="{{URL::to('/delete-comment/'.$comm->comment_id)}}">
