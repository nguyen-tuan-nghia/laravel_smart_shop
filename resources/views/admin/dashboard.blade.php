...
<div class="row">
		...
		<form autocomplete="off">
			...
			<div class="col-md-2">
				<p>Từ ngày:</p> <input style="float: left;width:160px" type="text" id="datepicker" class="form-control">
...
<br>
			...
			<div class="col-md-2">
				<p>Đến ngày:</p> <input style="float: left;width:160px" type="text" id="datepicker2" class="form-control">
               <span class="glyphicon glyphicon-calendar"></span>
		...
		<div class="col-md-3">
			<div id="sum" style="height: 100px;"></div>
		</div>
...
<div class="row">
	...
	<div class="col-md-4 col-xs-12">
		...
		<ol class="list_views">
			...
			<li>
				<a target="_blank" href="{{url('/tin-tuc/'.$post->category_post->category_post_slug.'/'.$post->post_slug)}}">{{$post->post_title}} | <span style="color:black">{{$post->post_views}}</span></a>
			</li>
			@endforeach
		</ol>
